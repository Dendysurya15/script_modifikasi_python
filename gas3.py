...
base_weight_dirs = [
    # '/home/grading/yolov8/2024-06-18-08-29_yolov8n_1280_111_pokok_kuning/train/weights/',
    # '/home/grading/yolov8/2024-06-16-02-12_yolov5xu_1280_111_pokok_kuning/train/weights/',
    '/home/grading/yolov8/2024-06-15-18-17_yolov5mu_1280_111_pokok_kuning/train/weights/',
    # '/home/grading/yolov8/2024-06-15-05-00_yolov8x_1280_111_pokok_kuning/train/weights/',
    # '/home/grading/yolov8/2024-06-14-21-49_yolov8l_1280_111_pokok_kuning/train/weights/',
    # '/home/grading/yolov8/2024-06-14-14-37_yolov8m_1280_111_pokok_kuning/train/weights/',
    # '/home/grading/yolov8/2024-06-14-07-24_yolov8s_1280_111_pokok_kuning/train/weights/'
...
image_dir = '/home/grading/test/test/'

# List all image files in the image directory
image_files = [os.path.join(image_dir, f) for f in os.listdir(image_dir) if f.lower().endswith(('.jpg', '.jpeg', '.png', '.bmp', '.gif', '.tif'))]

# Define the minimum and maximum image size
min_imgsz = 352  # Minimum size based on YOLOv5 requirements
# max_imgsz = 15000  # Example maximum size (adjust based on your GPU's capabilities)
max_imgsz = 8000  # Example maximum size (adjust based on your GPU's capabilities)
...
confidence_levels = [0.01]  # Add more confidence levels as needed
